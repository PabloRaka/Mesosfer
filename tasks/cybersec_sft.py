...
class ChatHistoryDistilledSFT(RobustCustomJSON):
    """Distilled pair-programming and AI engineering conversations generated by dev/export_chat_history_to_sft.py."""
    def __init__(self, sft_dir=None, **kwargs):
