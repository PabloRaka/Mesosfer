...
parser.add_argument("--cyber-defensive-epochs", type=int, default=8, help="epochs of cyber_defensive_conversations (96 rows x language, deduped from 5K)")
parser.add_argument("--cloud-security-epochs", type=int, default=8, help="epochs of cloud_security_sft (6 rows x language, oversampled)")
...
parser.add_argument("--tool-oriented-epochs", type=int, default=8, help="epochs of tool_oriented_cyber_sft (8 rows, oversampled)")
parser.add_argument("--mythos-epochs", type=int, default=8, help="epochs of mythos_combined_sft (55 rows x language, multi-step tool use)")
parser.add_argument("--mythos-tool-calling-epochs", type=int, default=4, help="epochs of mythos_tool_calling (110 rows x language, native tool format)")
...
parser.add_argument("--tool-calling-epochs", type=int, default=8, help="epochs of tool_calling_conversations_en (122 rows, calc/tool parts)")
